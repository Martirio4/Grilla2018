package com.auditoria.audit5S_Full.DAO;
...
public class ControllerDatos {
    ...
    //region INSTANCIADOR ORIGINAL
    /*
    public String instanciarAuditoriaViejoMetodo(final String tipoArea){
        ...
        realm.executeTransaction(new Realm.Transaction() {
            ...
            public void execute(Realm realm) {
                Auditoria nuevaAuditoria = realm.createObject(Auditoria.class,"Audit_" + UUID.randomUUID());
...
//                    PRIMER ESE
                //SI ES AREA INDUSTRIAL
                if (tipoArea.equals("A")) {
...
//                      QUINTO ITEM
                ...
                //SI ES AREA DE OFICINAS
                if (tipoArea.equals("B")) {
                    Ese ese1= realm.createObject(Ese.class);
                    ese1.setIdAudit(nuevaAuditoria.getIdAuditoria());
                    ese1.setIdEse("1");
                    ese1.setPuntajeEse(0.0);
...
//                      TERCER ITEM
                    ...
                    pregunta133.setIdAudit(nuevaAuditoria.getIdAuditoria());
...
//                      QUINTO ITEM
                    ...
                    pregunta255.setIdAudit(nuevaAuditoria.getIdAuditoria());
                    ...
                    pregunta256.setIdAudit(nuevaAuditoria.getIdAuditoria());
...
//                      QUINTO ITEM
    ...
    public Auditoria traerAuditoria(String letra){
        Realm realm = Realm.getDefaultInstance();
        Auditoria laAuditBuscada = realm.where(Auditoria.class)
                .equalTo("idAuditoria", "Audit_modelo"+letra)
                .findFirst();
       return laAuditBuscada;
    }
